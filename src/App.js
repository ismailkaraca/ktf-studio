...
export default function App() {
    ...
    const handleGenerateImage = async (mode, prompt) => {
        ...
        const apiKey = ""; // API Key injected here
                    const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/imagen-3.0-generate-001:predict:generateContent?key=${AIzaSyCzkmhEoEMs06w72OTgnR-HMP5adSHgqnQ}`;
