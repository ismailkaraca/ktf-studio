...
export default function App() {
    ...
    const handleGenerateImage = async (mode, prompt) => {
        ...
        const apiKey = ""; // API Key injected here
                    const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview:predict:generateContent?key=${AIzaSyCzkmhEoEMs06w72OTgnR-HMP5adSHgqnQ}`;
